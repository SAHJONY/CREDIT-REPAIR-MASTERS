  ...
  return (
    <main className="homePremium">
      <section className="hmHero">
        ...
        <div className="hmHeroVisual"><FinancialVisual variant="mortgage" label="New850 mortgage readiness" /></div>
      </section>
      ...
      <section className="hmSection">
        <div className="hmSplit">
          <FinancialVisual variant="documents" label="Mortgage document readiness" />
