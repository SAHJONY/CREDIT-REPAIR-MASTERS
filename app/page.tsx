    ...
    <main className="referenceLanding">
      <header className="referenceTopbar">
        ...
        <nav className="referenceNav" aria-label="Primary">
          <Link className="active" href="/">Home</Link><Link href="/services">Services</Link><Link href="/get-started">How It Works</Link><Link href="/loan-readiness">Readiness</Link><Link href="/services">Pricing</Link><Link href="/portal">Education</Link><Link href="/services">About Us</Link>
        </nav>
        <div className="referenceActions"><Link className="referencePhone" href="/portal/sign-in">Client Portal</Link><Link className="referenceGetStarted" href={funnelHref(params)}>Check Your Readiness</Link></div>
      </header>
      ...
      <div className="referenceContent">
        <section className="referenceHero">
          ...
          <div className="referenceHeroCopy">
            ...
            <div className="referenceHeroButtons"><Link className="referencePrimary" href={funnelHref(params)}>Check Your Readiness <span>→</span></Link><Link className="referenceSecondary" href="/portal/sign-in">Track Your Progress</Link></div>
          </div>
          <aside className="referenceHealth">
            <h3>Example Approval Readiness</h3>
            <div className="referenceHealthScore"><div><strong>76</strong><small>Building</small></div></div>
            <div className="referenceHealthMeta"><b>Target: 85+ and zero P0 blockers</b><span>Illustrative planning score · not a lender decision</span></div>
          </aside>
        </section>
        ...
        <section className="referenceLower">
          <div className="referencePanel">
            <div className="referencePanelInner"><h3>Your Readiness Journey</h3><div className="referenceTimeline">
            ...
            <div className="referenceAspirational"><div className="referencePanelInner"><span className="referencePill">MEASURE → IMPROVE → REASSESS</span><h2>Turn Credit Improvement Into Application Readiness.</h2><ul><li>Identify the highest-impact blockers first</li><li>Build measurable 7/30/60/90-day actions</li><li>Track progress against your financing goal</li><li>Shop for credit only when your profile is better prepared</li></ul><Link className="referencePrimary" href={funnelHref(params)}>Build Your Readiness Plan →</Link></div></div>
          </div>

          <div className="referencePanel referenceAspirational"><div className="referencePanelInner"><span className="referencePill">ONE GOVERNED WORKSPACE</span><h2>From Credit Problem To Financial Readiness.</h2><p>Reports, evidence, authorizations, readiness assessments, action plans, progress and approved payments stay connected in one secure workspace.</p><Link className="referencePrimary" href="/portal/sign-in">Enter Client Portal →</Link></div></div>

          <div className="referenceSideStack">
            <div className="referencePanel referenceQuote"><h3>Built for Better Decisions</h3><div className="stars">★★★★★</div><p>Understand what is limiting your profile, what to address next, and whether you are better prepared than at your last assessment.</p><small>Readiness scores are planning tools. No score increase, deletion, financing approval, rate or lender outcome is guaranteed.</small></div>
            <div className="referencePanel referenceEducation"><h3>Financial Education</h3><div className="referenceArticle"><div className="referenceArticleVisual"/><div><b>How Utilization Affects Approval Readiness</b><span>Understand one of the highest-impact revolving-credit metrics.</span></div></div><div className="referenceArticle"><div className="referenceArticleVisual"/><div><b>Preparing Before You Apply</b><span>Organize credit, debt, reserves and documents before financial shopping.</span></div></div></div>
          </div>
        </section>
