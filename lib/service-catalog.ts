...
export const commercialServices: CommercialService[] = [
  {
    ...
    deliverables: [
      ...
      'Utilization and derogatory-account analysis',
      'Evidence inventory',
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Legitimate dispute preparation',
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Furnisher correspondence preparation',
      'Escalation planning',
      'Complex bureau-response analysis'
    ],
    paymentPolicy: 'post_performance'
  },
  {
