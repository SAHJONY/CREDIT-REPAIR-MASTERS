...
export function getPaymentProviders(): PaymentProviderStatus[] {
  return [
    { id: 'square', name: 'Square', configured: configured('SQUARE_ACCESS_TOKEN', 'SQUARE_LOCATION_ID', 'NEXT_PUBLIC_SQUARE_APPLICATION_ID'), mode: 'processor', methods: ['debit_card', 'credit_card', 'cash_app_pay', 'apple_pay', 'google_pay'], detail: 'Card processor; Cash App Pay and eligible digital wallets use the Square payment stack.' },
