  ...
  return (
    <main>
      <header className="appHeader">
        ...
        <div className="headerActions"><Link className="primaryButton" href="/get-started">Get started</Link><Link className="secondaryButton" href="/services">Services & pricing</Link><Link className="secondaryButton" href="/portal/sign-in">Client sign in</Link><Link className="secondaryButton" href="/auth/sign-in">Staff sign in</Link></div>
      </header>

      <section className="grid">
        <div className="card span4"><div className="label">Personal credit</div><h2>Consumer intelligence</h2><p className="small">Normalize reports, identify potentially inaccurate or unsupported reporting, organize evidence, monitor responses, and build a prioritized improvement plan.</p><div className="headerActions" style={{ marginTop: 14 }}><Link className="primaryButton" href="/get-started?service=credit-intelligence-audit">Start with an audit</Link></div></div>
        <div className="card span4"><div className="label">Business credit</div><h2>Readiness & advisory</h2><p className="small">Assess business profile quality, documentation readiness, reporting strategy, funding readiness, and implementation milestones.</p><div className="headerActions" style={{ marginTop: 14 }}><Link className="primaryButton" href="/get-started?service=business-credit-accelerator">Explore business credit</Link></div></div>
        <div className="card span4"><div className="label">For professionals</div><h2>CREDIT REPAIR MASTERS OS</h2><p className="small">Operate client work with a tenant-scoped evidence ledger, AI analysis, compliance workflow, approvals, audit trail, private documents, and client portal.</p><div className="headerActions" style={{ marginTop: 14 }}><Link className="primaryButton" href="/get-started?service=credit-os-professional">Explore the OS</Link></div></div>
        ...
        <div className="card span12">
          <div className="row">
            ...
            <Link className="primaryButton" href="/get-started">Choose my path</Link>
          </div>
        </div>
      </section>
