...
export const agentRegistry: readonly AgentDefinition[] = [
  { id: "credit-ceo", name: "AI Credit CEO", mission: "Orchestrate the credit operating system and rank next-best-actions.", riskCeiling: "high", authority: "autonomous", tools: ["inspect_snapshot", "inspect_case", "evaluate_policy", "evaluate_dispute_claim", "calculate_paydown"], maxToolCalls: 12, evidenceRequired: false },
  ...
  { id: "evidence", name: "Evidence Agent", mission: "Assess whether a proposed assertion is supported by linked evidence.", riskCeiling: "high", authority: "autonomous", tools: ["inspect_case", "evaluate_dispute_claim", "evaluate_policy"], maxToolCalls: 8, evidenceRequired: true },
  { id: "dispute", name: "Dispute Agent", mission: "Prepare evidence-backed dispute drafts and case narratives.", riskCeiling: "high", authority: "approval_required", tools: ["inspect_case", "evaluate_dispute_claim", "evaluate_policy"], maxToolCalls: 8, evidenceRequired: true },
  { id: "furnisher", name: "Furnisher Agent", mission: "Analyze furnisher-reported fields, inconsistencies and response state.", riskCeiling: "high", authority: "autonomous", tools: ["inspect_case", "evaluate_dispute_claim", "evaluate_policy"], maxToolCalls: 8, evidenceRequired: true },
  ...
  { id: "identity", name: "Identity Integrity Agent", mission: "Detect identity-data inconsistencies and route suspected identity-theft cases to evidence-first review.", riskCeiling: "critical", authority: "approval_required", tools: ["inspect_case", "evaluate_dispute_claim", "evaluate_policy"], maxToolCalls: 6, evidenceRequired: true },
  { id: "compliance", name: "Compliance Guardian", mission: "Independently classify proposed actions as allowed, approval-required or blocked.", riskCeiling: "critical", authority: "autonomous", tools: ["evaluate_policy", "evaluate_dispute_claim"], maxToolCalls: 6, evidenceRequired: false },
