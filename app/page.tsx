    ...
    <main className="referenceLanding">
      ...
      <div className="referenceContent">
        ...
        <section className="pageVisualBand">
          <CinematicPhoto variant="pacific" label="Confident mobility and financial progress" />
