...
export const es: Record<string, string> = {
  ...
  // ── owner intake (New850 case intake) ────────────────────────────
  "intake.title": "Casos de crédito",
  "intake.subtitle":
    "Agregue clientes y sus reportes de crédito. El teléfono se guarda cifrado y todo queda en borrador hasta su aprobación.",
  "intake.newCase": "Nuevo caso",
  "intake.customerName": "Nombre del cliente",
  "intake.customerNamePh": "Nombre y apellido",
  "intake.phone": "Teléfono / WhatsApp",
  "intake.phonePh": "+1 555 123 4567",
  "intake.phoneHelp": "Se guarda cifrado. Solo se muestra enmascarado (***4567).",
  "intake.notes": "Notas",
  "intake.notesPh": "Notas del caso (no incluya el número de seguro social)",
  "intake.reportFile": "Reporte de crédito (PDF, JPG o PNG)",
  "intake.reportHelp": "Opcional ahora — puede adjuntarlo después.",
  "intake.ssnAttestation":
    "Confirmo que el número de seguro social fue tachado en el reporte (o el cliente autorizó compartirlo sin tachar).",
  "intake.submit": "Crear caso",
  "intake.submitting": "Creando…",
  "intake.caseList": "Casos",
  "intake.noCases": "Aún no hay casos. Cree el primero arriba.",
  "intake.status": "Estado",
  "intake.report": "Reporte",
  "intake.reportYes": "Adjunto",
  "intake.reportNo": "Pendiente",
  "intake.pipeline": "Seguimiento",
  "intake.created": "Creado",
  "intake.error": "No se pudo crear el caso. Inténtelo de nuevo.",
  "intake.errorWithCode": "No se pudo crear el caso ({code}).",
  "intake.success": "Caso creado para {name}.",
  "intake.status.new": "Nuevo",
  "intake.status.report_received": "Reporte recibido",
  "intake.status.analyzing": "En análisis",
  "intake.status.ready_for_round1": "Listo para ronda 1",
  "intake.status.in_dispute": "En disputa",
  "intake.status.done": "Completado",
  "intake.status.closed": "Cerrado",
...
export const en: Record<string, string> = {
  ...
  // ── owner intake (New850 case intake) ────────────────────────────
  "intake.title": "Credit cases",
  "intake.subtitle":
    "Add customers and their credit reports. Phones are stored encrypted and everything stays draft until you approve it.",
  "intake.newCase": "New case",
  "intake.customerName": "Customer name",
  "intake.customerNamePh": "Full name",
  "intake.phone": "Phone / WhatsApp",
  "intake.phonePh": "+1 555 123 4567",
  "intake.phoneHelp": "Stored encrypted. Only shown masked (***4567).",
  "intake.notes": "Notes",
  "intake.notesPh": "Case notes (do not include the Social Security number)",
  "intake.reportFile": "Credit report (PDF, JPG or PNG)",
  "intake.reportHelp": "Optional for now — you can attach it later.",
  "intake.ssnAttestation":
    "I confirm the Social Security number was redacted from the report (or the customer authorized sharing it unredacted).",
  "intake.submit": "Create case",
  "intake.submitting": "Creating…",
  "intake.caseList": "Cases",
  "intake.noCases": "No cases yet. Create the first one above.",
  "intake.status": "Status",
  "intake.report": "Report",
  "intake.reportYes": "Attached",
  "intake.reportNo": "Pending",
  "intake.pipeline": "Pipeline",
  "intake.created": "Created",
  "intake.error": "Could not create the case. Please try again.",
  "intake.errorWithCode": "Could not create the case ({code}).",
  "intake.success": "Case created for {name}.",
  "intake.status.new": "New",
  "intake.status.report_received": "Report received",
  "intake.status.analyzing": "Analyzing",
  "intake.status.ready_for_round1": "Ready for round 1",
  "intake.status.in_dispute": "In dispute",
  "intake.status.done": "Done",
  "intake.status.closed": "Closed",
